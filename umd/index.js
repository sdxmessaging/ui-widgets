...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('mithril'), require('luxon'), require('mithril/stream'), require('signature_pad')) :
    typeof define === 'function' && define.amd ? define(['exports', 'lodash', 'mithril', 'luxon', 'mithril/stream', 'signature_pad'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.uiWidgets = {}, global._, global.m, global.luxon, global.m.stream, global.SignaturePad));
}(this, (function (exports, lodash, m, luxon, stream, SignaturePad) { 'use strict';
    ...
    class HiddenDateInput {
        view({ attrs }) {
            ...
            return m__default['default']('input', {
                style: { display: 'none' },
                id
            });
        }
    ...
    class CardDateInput {
        constructor() {
            ...
            this.valid = stream__default['default'](true);
        ...
        view({ attrs }) {
            ...
            return m__default['default'](LayoutFixed, { value, field, invalid: (!this.valid() && Boolean(required)) || (!this.valid()) }, m__default['default']('.flex', {
                ...
                m__default['default']("input.w-100.bg-transparent.bn.outline-0.tc", {
                    ...
                    onblur: lodash__default['default'].partial(appendZeroToDayMonth, this.month)
                })
            ...
            const createDateInputs = ({ type, value }) => {
                switch (type) {
                    ...
                    case ('day'): return m__default['default']("span", m__default['default']("input.w-100.bg-transparent.bn.outline-0.tc", {
                        ...
                        onblur: lodash__default['default'].partial(appendZeroToDayMonth, this.day),
                        style: {
