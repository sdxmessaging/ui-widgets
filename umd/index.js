/* @preserve built on: 2021-10-05T08:41:41.372Z */
(function (global, factory) {
    ...
    class BaseInputInternalLabel {
        constructor() {
            this.selected = stream__default['default'](false);
        ...
        oninit({ attrs: { value } }) {
            this.value = value;
            this.selected.map(m__default['default'].redraw);
        }
        onupdate({ attrs: { field: { shrink } } }) {
        ...
        view({ attrs: { field, value, xform = value } }) {
            const { label, id, type = "text" /* text */, name = id, title = label, disabled, instant, uiClass = {} } = field;
            return m__default['default'](".relative.flex", {
                class: type === "hidden" /* hidden */ ? "clip" : wrapperCls(uiClass, disabled),
                style: {
                    pointerEvents: 'none',
                    height: '4rem'
                ...
                m__default['default'](".flex", {
                    ...
                    [instant ? "oninput" : "onchange"]: setValue(value), style: {
                        ...
                        pointerEvents: 'auto',
                        margin: '0 1rem',
                    } })), m__default['default']('fieldset.absolute', {
                    style: {
                        inset: '-11px 0 0',
                        padding: '0 8px',
                        top: '0',
    ...
    class BaseInput {
        view({ attrs }) {
            ...
            return !floatLabel
                ? m__default['default'](BaseInputExternalLabel, attrs, shrink)
                : m__default['default'](BaseInputInternalLabel, attrs);
        }
    }
