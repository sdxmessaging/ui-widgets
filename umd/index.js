/* @preserve built on: 2021-09-15T10:17:07.939Z */
(function (global, factory) {
    ...
    class DateInput {
        constructor() {
            ...
            this.year = stream__default['default']();
            // Combine date parts
            this.date = stream__default['default'].lift((day, month, year) => `${year}-${month}-${day}`, this.day, this.month, this.year);
        }
        oninit({ attrs: { value } }) {
            // Split value into date parts
            value.map((newVal) => {
    ...
    class TextareaInput {
        view({ attrs: { field, value } }) {
            ...
            return m__default['default']("fieldset.flex.flex-column.h-100", {
                class: wrapperCls(uiClass, disabled)
            }, [
                getLabel(id, uiClass, label, required),
