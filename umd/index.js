...
(function (global, factory) {
    ...
    class InputInternalLabel {
        ...
        view(vnode) {
            ...
            return m__default['default']("fieldset.relative.flex", {
                ...
                m__default['default']("label.db.top-0.left-0.absolute.z-1", {
                    title: label,
                    style: {
                ...
                }, m__default['default']('.flex.flex-row.w-100.z-1', { onfocusin: this.focusIn, onfocusout: this.focusOut }, this.viewInput(vnode)), m__default['default']('fieldset.absolute.ba.b--light-gray.ph1', {
                    style: {
                        top: '-5px',
                        right: '-2px',
                        bottom: '0px',
    ...
    class CardDateInput {
        ...
        view({ attrs }) {
            ...
            ]) : m__default['default'](ViewInputOverride, Object.assign(Object.assign({}, attrs), { children: dateInputs }));
        }
    }
    ...
    class DateInput {
        ...
        view({ attrs }) {
            ...
            return !floatLabel
                ...
                : m__default['default'](ViewInputOverride, Object.assign(Object.assign({}, attrs), { children: dateInput }));
        }
    }
